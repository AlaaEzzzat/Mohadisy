...
@Component({
  selector: 'app-sp-cproject-accept',
  templateUrl: './sp-cproject-accept.component.html',
  styleUrls: ['./sp-cproject-accept.component.scss'],
})
export class SpCprojectAcceptComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.api
      .get(
        'https://app.mohandisy.com/api/PriceQuotes/getSPAcceptedOffers/Page/1'
      )
      .subscribe((data) => {
