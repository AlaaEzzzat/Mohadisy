...
@Component({
  selector: 'app-sp-request-reject',
  templateUrl: './sp-request-reject.component.html',
  styleUrls: ['./sp-request-reject.component.scss']
})
export class SpRequestRejectComponent implements OnInit {
