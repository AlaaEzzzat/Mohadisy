...
@Component({
  selector: 'app-sp-project-negotiation',
  templateUrl: './sp-project-negotiation.component.html',
  styleUrls: ['./sp-project-negotiation.component.scss']
})
export class SpProjectNegotiationComponent implements OnInit {
 ...
 ngOnInit(): void {
   ...
   this.api.get("https://app.mohandisy.com/api/PriceQuotes/getSPUnderNegotiationOffers/Page/1").subscribe(data=>{
 ...
 showData(idProject:number)
 {
   ...
   (data=>{
    ...
    changepage(e:any)
    {
     ...
     this.api.get(`https://app.mohandisy.com/api/PriceQuotes/getSPUnderNegotiationOffers/Page/${this.page}`).subscribe(data=>{
